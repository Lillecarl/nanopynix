{
  ...
  outputs =
    ...
    in
    {
      ...
      # This repository ships no service module. The two it had wrapped the
      # NixOS and darwin modules of `pynixd/`, which now lives in its own
      # repository again and carries them.
