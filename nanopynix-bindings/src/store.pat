...
nanopynix_bindings.store.Store.query_missing:
    def query_missing(self, paths: Sequence[StorePath]) -> MissingPaths: ...
...
nanopynix_bindings.store.Store.build_paths_with_results:
    def build_paths_with_results(self, paths: Sequence[StorePath], build_mode: BuildMode = BuildMode.Normal, eval_store: Store | None = None) -> list[BuildResult]: ...
