    ...
    *,
    ...
    while True:
        ...
        if target.file is None:
            raise BuildTargetError("--update-fod currently requires --file") from build_error
        if updates >= 10:
            raise BuildTargetError("stopped after 10 fixed-output hash updates") from build_error
        try:
