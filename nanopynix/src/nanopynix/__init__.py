...
_NAME_TO_MODULE: typing.Final[dict[str, str]] = {
    ...
    "get_flake": "nanopynix._engine",
    "get_verbosity": "nanopynix._engine",
    "init_libexpr": "nanopynix._engine",
    "init_libstore": "nanopynix.libstore",
    "input_from_attrs": "nanopynix._engine",
    "input_from_url": "nanopynix._engine",
