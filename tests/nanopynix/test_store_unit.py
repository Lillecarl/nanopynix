...
class TestIdentity:
    ...
    async def test_add_to_store_injects_store_handle(self, store: Store, pool: MagicMock):
        ...
        assert result.to_string ==  # type: ignore[attr-defined] -- StorePath nanobind type, to_string not in stubs "aaa-added"
    ...
    async def test_compute_store_path_injects_store_handle(self, store: Store, pool: MagicMock):
        ...
        assert result.to_string ==  # type: ignore[attr-defined] -- StorePath nanobind type, to_string not in stubs "bbb-added"
...
class TestStorePathCoercion:
    async def test_parse_store_path_returns_proto(self, store: Store, pool: MagicMock):
        ...
        assert result.to_string ==  # type: ignore[attr-defined] -- StorePath nanobind type, to_string not in stubs "aaa-bbb"
...
class TestPathInfo:
    ...
    async def test_query_path_from_hash_part_found(self, store: Store, pool: MagicMock):
        ...
        assert result.path.to_string ==  # type: ignore[attr-defined] -- StorePath nanobind type, to_string not in stubs "aaa-foo"
