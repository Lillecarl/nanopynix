...
from pynixd.operations.base import BasicDerivation, UnkeyedValidPathInfo, BuildResult, BuildResultStatus
...
async def test_scheduler_flood_queueing():
    ...
    for i in range(10):
        ...
        _bid, fut = await scheduler.queue.enqueue(
            req, None, required_paths=info_map, platform="x86_64-linux"
        )
        futures.append(fut)
