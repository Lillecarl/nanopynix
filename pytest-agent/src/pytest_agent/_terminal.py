...
class RealTerminal:
    ...
    per-test buffer for most of the session, including while a test is
    mid-execution -- exactly when a periodic progress line is most useful,
    since a test that never finishes is the "stuck" signal. Writing through
    this duplicated fd instead of `sys.stdout`
